...
namespace F1Telemetry
{
    public class TelemetryStructures
    {
        ...
        public struct PacketSessionData
        {
            ...
            public short m_trackLength;               // Track length in metres
            ...
            public byte m_formula;                   // Formula, 0 = F1 Modern, 1 = F1 Classic, 2 = F2,
                                               // 3 = F1 Generic
            public short m_sessionTimeLeft;           // Time left in session in seconds
            public short m_sessionDuration;           // Session duration in seconds
        ...
        public struct LapData
        {
            ...
            //UPDATED in Beta 3:
            public short m_sector1TimeInMS;           // Sector 1 time in milliseconds
            public short m_sector2TimeInMS;           // Sector 2 time in milliseconds
            ...
            public short m_bestLapSector1TimeInMS;    // Sector 1 time of best lap in the session in milliseconds
            public short m_bestLapSector2TimeInMS;    // Sector 2 time of best lap in the session in milliseconds
            public short m_bestLapSector3TimeInMS;    // Sector 3 time of best lap in the session in milliseconds
            public short m_bestOverallSector1TimeInMS;// Best overall sector 1 time of the session in milliseconds
            public byte m_bestOverallSector1LapNum;  // Lap number best overall sector 1 time achieved on
            public short m_bestOverallSector2TimeInMS;// Best overall sector 2 time of the session in milliseconds
            public byte m_bestOverallSector2LapNum;  // Lap number best overall sector 2 time achieved on
            public short m_bestOverallSector3TimeInMS;// Best overall sector 3 time of the session in milliseconds
        ...
        public struct CarTelemetryData
        {
            ...
            public short m_engineRPM;                     // Engine RPM
            public byte m_drs;                           // 0 = off, 1 = on
            public byte m_revLightsPercent;              // Rev lights indicator (percentage)
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            public short[] m_brakesTemperature;          // Brakes temperature (celsius)
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
            ...
            public short m_engineTemperature;             // Engine temperature (celsius)
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 4)]
        ...
        public struct CarStatusData
        {
            ...
            public short m_maxRPM;                   // Cars max RPM, point of rev limiter
            public short m_idleRPM;                  // Cars idle RPM
            public byte m_maxGears;                 // Maximum number of gears
            public byte m_drsAllowed;               // 0 = not allowed, 1 = allowed, -1 = unknown


            // Added in Beta3:
            public short m_drsActivationDistance;    // 0 = DRS not available, non-zero - DRS will be available
                                                     // in [X] metres
